...
std::unique_ptr<TextureHandler> TextureHandler::textureInstance = nullptr; //gotta redeclare static variable
std::vector<Texture*> TextureHandler::textures = std::vector<Texture*>();

TextureHandler::TextureHandler() {
	textures.reserve(10); //goes into memory, takes 10 times bytes and reserves that chunk of memory for textures
}
